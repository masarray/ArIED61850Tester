...
/// <summary>
/// Lightweight presentation policy for the two operator signal viewers, the ballistic
/// navigation spacing, and the high-consequence Open/Close command actions.
/// It changes presentation only; MMS, reporting, monitoring, and control dispatch remain untouched.
/// </summary>
internal static class SignalViewerAndControlUxPolicy
{
    ...
    private static void OnWindowLoaded(object sender, RoutedEventArgs args)
    {
        ...
        // SasOperationalUiPolicy installs the ballistic template at Loaded priority.
        // Run after it so spacing remains deterministic without adding layout animation.
